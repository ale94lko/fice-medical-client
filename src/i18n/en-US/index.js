export default {
  ...
  portalCopyright:
    '© {year} FiCE Medical. All rights reserved.',
  ...
  kpiUpcomingLabel: 'Upcoming visits',
  kpiUpcomingHint: 'Appointments scheduled',
  kpiRequestsLabel: 'Pending confirmation',
  kpiRequestsHint: 'Appointment requests',
  kpiDocumentsLabel: 'Uploaded recently',
  kpiDocumentsHint: 'Documents',
  kpiConsentsLabel: 'Action required',
  kpiConsentsHint: 'Consents to review',
  dashboardTasksTitle: 'Tasks & reminders',
  dashboardTasksEmpty: 'You have nothing waiting right now.',
  dashboardTaskCompleteProfile: 'Complete your profile',
  dashboardTaskSignConsent: 'Sign {name}',
  quickActionsTitle: 'Quick actions',
  quickActionBook: 'Book appointment',
  quickActionDocuments: 'View documents',
  quickActionConsents: 'View consents',
  quickActionMessage: 'Message clinic',
  quickActionProfile: 'Update profile',
